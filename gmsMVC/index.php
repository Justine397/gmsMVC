...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    include_once 'controllers/LoginController.php'; // Include the controller

    $controller = new LoginController($conn); // Instantiate the controller with the database connection
